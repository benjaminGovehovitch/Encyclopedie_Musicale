...
jQuery(function ($) {
    ...
    if (supportsAudio) {
        var index = 0,
            playing = false,
            mediaPath = 'https://archive.org/download/Satie_La_belle_excentrique_Orchestre/',
            extension = '',
                        tracks = [{
                "track": 1,
                "name": "Grande ritournelle",
                "length": "1:57",
                "file": "01_Grande_ritournelle"
	    },{
                "track": 2,
                "name": "Marche franco-lunaire",
                "length": "1:41",
                "file": "02_Marche_franco_lunaire"
	    },{
                "track": 3,
